...
class Thirdscene extends Phaser.Scene {
    ...
    create() {
        ...
        // PLAYER
        this.player = new Player(this, this.sys.game.canvas.width / 2, this.sys.game.canvas.height, 'playersprite');
        this.player_verde = new Player(this, this.sys.game.canvas.width / 2 + 100, this.sys.game.canvas.height, 'playersprite');
